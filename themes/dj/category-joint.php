<?php $metaDesc = "All the things that Dave and Jolin do together, Baking, Woodworks, and maybe eating delicious chocolate cake?"; ?>
...
<?php $article_categories = get_categories(array(
	...
	<div class="heart">
		...
		<h1>Things Dave and Jolin do together</h1>
	...
	<?php else : ?>
		...
		<h2 class="center">No Joint posts!</h2>
		<p class="center">Sorry, but both these folks are quite lazy and useless.</p>
